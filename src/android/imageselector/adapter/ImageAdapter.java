package com.imageselect.yhck.imageselector.adapter;
...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    //保存选中的图片
    private ArrayList<Image> mSelectImages = new ArrayList<Image>();
    ...
    public ImageAdapter(Context context, int maxCount, boolean isSingle) {
        mContext = context;
        mSharedPre = mContext.getSharedPreferences("imagePath", Context.MODE_PRIVATE);
        mChooseImagePath = mSharedPre.getString("PATH", "");
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        //TODO 2017.09.11: kevin add
        if (image.getPath().equals(mChooseImagePath)) {
            mSelectImages.clear();
            selectImage(image);
        }
