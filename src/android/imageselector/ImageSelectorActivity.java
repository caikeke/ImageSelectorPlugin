package com.imageselect.yhck.imageselector;
...
import com.imageselect.yhck.imageselector.adapter.FolderAdapter;
import com.imageselect.yhck.imageselector.adapter.ImageAdapter;
import com.imageselect.yhck.imageselector.constant.Constants;
import com.imageselect.yhck.imageselector.constant.Folder;
import com.imageselect.yhck.imageselector.entry.Image;
import com.imageselect.yhck.imageselector.model.ImageModel;
import com.imageselect.yhck.imageselector.utils.DateUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private void confirm() {
        ...
        //TODO 2017.09.11:Kecin 存储已选图片（单选存储第一个就行）
        SharedPreferences mSharedPre = getSharedPreferences("imagePath", Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPre.edit();
        if (images.size() > 0) {
            mEditor.putString("PATH", images.get(0));
        }
        mEditor.commit();
